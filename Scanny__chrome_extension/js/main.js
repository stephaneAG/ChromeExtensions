(function(){
  ...
  var baudPicker = document.getElementById('baudrates');
  ...
  var baudrates = [300, 1200, 2400, 4800, 9600, 14400, 19200, 28800, 38400, 57600, 115200 ]; // array of all possible baud rates
  ...
  // -- code handling populating the baud rate select --
  
  var populateBauds = function(){
     console.log("Available baud rates:");
    for (var i=0; i<baudrates.length; i++) {
      var option = document.createElement('option');
      option.value = option.innerText = baudrates[i];
      console.log(baudrates[i]);
      baudPicker.appendChild(option);
    }
  };
  populateBauds(); // call the function defined right above
